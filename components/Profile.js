    ...
    try {
        ...
        return (
            <div className="flex gap-8 mt-12 items-start" data-name="profile-section">
                <div className="profile-image-container relative w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center overflow-hidden" data-name="profile-image">
                    <img 
                ...
                <div className="flex-1" data-name="profile-info">
                    ...
                    <p className="text-xl leading-relaxed mb-8 text-gray-800" data-name="introduction">
                        I am <span className="text-violet-600 font-semibold">Stephen Ndolo</span>, a passionate 
                        creative director and graphic designer with over 5 years of experience in crafting 
                        compelling visual narratives and building strong brand identities.
                    </p>
                    <div className="space-y-4" data-name="contact-info">
                        <div className="flex items-center gap-3 group cursor-pointer" data-name="behance-link">
                            ...
                            <a href="https://behance.net/stevohsmart" className="text-gray-600 hover:text-violet-600 transition-colors">behance.net/stevohsmart</a>
                        </div>
                        <div className="flex items-center gap-3 group cursor-pointer" data-name="phone-number">
                            ...
                            <span className="text-gray-600">+254 0746644085</span>
                        </div>
                        <div className="flex items-center gap-3 group cursor-pointer" data-name="email">
                            ...
                            <a href="mailto:Stevohsmart@gmail.com" className="text-gray-600 hover:text-pink-600 transition-colors">Stevohsmart@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
