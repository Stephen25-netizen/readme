                        ...
                        <form onSubmit={handleSubmit} className="relative bg-white/70 backdrop-blur-md rounded-xl p-6 space-y-6" data-name="contact-form">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 rounded-lg bg-white/50 border ${emailError ? "border-red-400" : "border-gray-200"} focus:border-violet-400 focus:ring-2 focus:ring-violet-100 outline-none transition-all`}
